...
static NSString *essentialUrlstr = @"http://www.shibeixuan.com/bibei/newbb.html";

@interface EssentialController()<UIWebViewDelegate>
...
@implementation EssentialController
...
-(void)loadWebView
{
    ...
    NSURL *url = [NSURL URLWithString:essentialUrlstr];
...
{
    if ([request.URL.absoluteString isEqualToString:essentialUrlstr]) {
